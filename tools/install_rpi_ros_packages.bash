...
function fk_deps() {
    ...
    sudo apt-get -y install ros-kinetic-navigation ros-kinetic-robot-localization ros-kinetic-roslint ros-kinetic-gmapping ros-kinetic-urdf ros-kinetic-xacro ros-kinetic-message-runtime ros-kinetic-teleop-twist-joy ros-kinetic-ros-control ros-kinetic-ros-controllers
